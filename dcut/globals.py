...
# Compatibility no-op: older editable installs / stale pycache may still import
# this symbol from the removed shared-GDN-buffer experiment.  Keep the constant
# defined so plugin import does not fail, but do not use it for behavior.
