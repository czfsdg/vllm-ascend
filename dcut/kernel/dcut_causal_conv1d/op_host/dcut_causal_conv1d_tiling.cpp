...
#include "../../../../csrc/moe/causal_conv1d/op_host/causal_conv1d_tiling_planner.h"
#include "../../../../csrc/moe/causal_conv1d/op_host/causal_conv1d_tiling_utils.h"
#include "../../../../csrc/moe/causal_conv1d/op_host/causal_conv1d_tiling_validation.h"
...
static ge::graphStatus CausalConv1dTilingFunc(gert::TilingContext* context) {
    ...
    OP_LOGD(context,
            ...
            static_cast<int32_t>(hasActivation), static_cast<int32_t>(hasBias),
            static_cast<int64_t>(fnExecutionPlan));
...
IMPL_OP_OPTILING(DcutCausalConv1d)
