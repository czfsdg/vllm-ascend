...
class NPUModelRunner(GPUModelRunner):
    ...
    def _disable_padded_drafter_batch_for_method(self) -> bool:
        ...
        # context tokens can still be attended by DFlash cross-attention and
        # corrupt generation when requests accept or verify different lengths.
        # Use compact drafter inputs until DFlash masks its context padding.
